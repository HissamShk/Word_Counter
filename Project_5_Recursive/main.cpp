...
//Word Counter (2.0)
//Hissamuddin Shaikh
//This program utilizes the class, Concordance_Recursive, to create a Concordance through a linked list,
//through a file inserted by the user. It exercises all the function of the Concordance class (except the destructor),
